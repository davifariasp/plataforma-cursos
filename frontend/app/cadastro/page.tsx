...
const registerSchema = z.object({
  nome: z.string()
    ...
    .regex(nameRegex, 'Nome deve ter pelo menos dois nomes, iniciando com maiúsculas'),
  ...
  senha: z.string()
    ...
    .regex(senhaRegex, 'Senha deve conter 8+ caracteres, maiúsculas, minúsculas, números e caracteres especiais'),
});
